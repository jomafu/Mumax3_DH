...
all: cudakernels hooks
	go install -v $(GO_BUILDFLAGS) github.com/jomafu/Mumax3_DH/...
...
test: all
	go test -vet=off -i github.com/jomafu/Mumax3_DH/...
	go test -vet=off $(PKGS)  github.com/jomafu/Mumax3_DH/...
	cd test && ./run.bash
...
clean:
	rm -frv $(GOPATH)/pkg/*/github.com/jomafu/Mumax3_DH/*
